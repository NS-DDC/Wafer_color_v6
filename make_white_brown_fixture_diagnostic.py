...
def main() -> None:
    ...
    # centre. It is the (x0, y0) street intersection nearest wafer centre,
    # which is the default robust API convention.
    ...
    cv2.putText(result, f"Nearest grid corner (x0, y0) = ({x0}, {y0})",
